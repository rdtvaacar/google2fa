...
namespace spec\Rdtvaacar\Google2FA;
...
class Google2FASpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Rdtvaacar\Google2FA\Google2FA');
    }
	...
	{
		$this->getQRCodeGoogleUrl('Rdtvaacar', 'acr+rdtvaacar@antoniocarlosribeiro.com', $this->secret)->shouldBe($this->url);
	}

	function it_converts_to_base32()
	{
		$this->toBase32('Rdtvaacar')->shouldBe('KBZGCZ3NMFJFQ');
	}
